...
namespace MyUtilities.DataBase.Sqlite
{
    public class SqliteDataBaseServices<TEntity, TKey> : IDataBaseServices<TEntity, TKey> where TEntity : class
    {
        ...
        public SqliteDataBaseServices(DbContext context, ILogger logger)
        {
